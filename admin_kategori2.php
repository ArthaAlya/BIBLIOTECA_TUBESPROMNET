...
<html lang="en">
 ...
 <div class="col-12">
    <div class="card recent-sales">
      <div class="card-body">
        <h5 class="card-title">Edit Books <span>| Comedy</span></h5>
        ...
        <table class="table table-borderless datatable">
          ...
          <tbody>
            ...
            ?>
            <tr>
              <td><img src="assets/img/book/Comedy/<?= $com["photo_book"]?>" widht="100px" height="100px"></td>
              <td><?= $com["name_book"]?></td>
              <td><?= $com["author"]?></td>
              <td>Rp <?= $com["book_price"]?></td>
              <td><a href="admin_updatebook.php?id=<?= $act["id_book"]?>"><i class="bi bi-pencil-square"></i></a> |
                <a href="admin_delete.php?id2=<?= $com["id_book"]?>" onclick="return confirm('Are you sure about this?');"><i class="bi bi-trash-fill"></i></a>
              </td>
            </tr>
            <?php
                endforeach;
