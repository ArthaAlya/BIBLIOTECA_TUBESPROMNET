<?php
  ...
  $book = query("SELECT * FROM book WHERE id_book = $id")[0];
  ...
  if(isset($_POST["update"])){
      ...
      if(ubah($_POST) > 0 ){
          ...
          echo "
              <script>
                  alert('Data has been unsuccessfully changed!');
                  document.location.href = 'admin_index.php';
              </script>
          ";
      }
        ...
        <div class="card recent-sales">
          <div class="card-body"><br>
            <form action="" method="post" enctype="multipart/form-data">
              ...
              <input type="hidden" name="oldPhoto_book" value="<?= $book["photo_book"]; ?>">
              <div class="input-group mb-3">
                <label class="input-group-text" for="id_category">ID Category</label>
                <input type="text" class="form-control" id="id_category" name="id_category" value="<?= $book["id_category"]; ?>">
              </div>
              <div class="mb-3">
              ...
              <div class="mb-3">
                ...
                <input class="form-control" type="file" id="photo_book" name="photo_book" value="<?= $book["photo_book"]; ?>">
              </div>
              <button type="submit" name="update" id="update" class="btn btn-outline-success">Update Book</button>
            </form>
          </div>
        </div>
      </div>
