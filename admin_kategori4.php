...
<html lang="en">
 ...
 <div class="col-12">
    <div class="card recent-sales">
      <div class="card-body">
        <h5 class="card-title">Edit Books <span>| Historical</span></h5>
        ...
        <table class="table table-borderless datatable">
          ...
          <tbody>
            ...
            ?>
            <tr>
              <td><img src="assets/img/book/Historical/<?= $his["photo_book"]?>" widht="100px" height="100px"></td>
              <td><?= $his["name_book"]?></td>
              <td><?= $his["author"]?></td>
              <td>Rp <?= $his["book_price"]?></td>
              <td><a href="admin_updatebook.php?id=<?= $act["id_book"]?>"><i class="bi bi-pencil-square"></i></a> |
                <a href="admin_delete.php?id4=<?= $his["id_book"]?>" onclick="return confirm('Are you sure about this?');"><i class="bi bi-trash-fill"></i></a>
              </td>
            </tr>
            <?php
                endforeach;
